...
$$\frac {\partial V(\vec x(t), t)}{\partial t} = \frac {\partial V(\vec x, t)}{\partial \vec x}\frac{\partial \vec x}{\partial t} + \frac {\partial V(\vec x, t)}{\partial t} = \text{spacial change + temporal change}$$ 
