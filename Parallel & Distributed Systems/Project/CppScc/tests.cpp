...
void trimVertices_sparse(const size_t n, const Sparse_matrix& inb, const Sparse_matrix& onb, std::vector<bool>& vleft) {
...
void trimVertices_sparse(const Sparse_matrix& inb, const Sparse_matrix& onb, std::vector<bool>& vleft, std::vector<size_t>& SCC_id, size_t& SCC_count) {
    size_t n = inb.n;
