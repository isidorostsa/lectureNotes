...
- To reduce the average energy we need to place the symbols closer to $\vec 0$, however this reduces their [[Eucledian Distance]], however this increases the [[error rate]].
